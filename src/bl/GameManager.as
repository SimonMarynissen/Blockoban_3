package bl {
	...
	public class GameManager extends EventDispatcher {
		...
		private var rcvconn:LocalConnection;
		private var	connectString:String = "BLConnectionRcv";
		private var	cursoroverbl:Boolean = false;
		private var	paused:Boolean = false;
		private var	plcmd:*;
		private var	blRc:Number;
		...
		/**
		 * If you game implements the best player data, you must call this function, usually at the beginning of the game. The BL API will reply by calling the blBestPlayerData function.
		 */
